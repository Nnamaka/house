...
interface FloatingHousesProps {
  // Define an interface for the props
  scroll: () => void; // scroll is a function that takes no arguments and returns void
}
...
const FloatingHouses: React.FC<FloatingHousesProps> = ({ scroll }) => {
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-5xl md:text-5xl z-50 text-white font-calendas italic">
          Discover beautifully designed, affordable, and sustainable tiny homes.
        </p>
        <Button className="bg-transparent" onClick={scroll}>
          <p className="text-xs z-50 hover:scale-110 transition-transform bg-white text-black rounded-full py-2 px-3 w-auto cursor-pointer">
            Explore Homes
          </p>
        </Button>
      </motion.div>
